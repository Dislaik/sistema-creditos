...
public class AuthController {
    ...
    public ResponseEntity register(@Valid @RequestBody NewUser newUser, BindingResult bindingResult) {
        ...
        Person person = new Person(newUser.getRun(), newUser.getDocument(), newUser.getFirstName(), newUser.getMiddleName(),
        ...
        User user = new User(username, passwordEncoder.encode(newUser.getPassword()), newUser.getEmail(), userRole, person);
